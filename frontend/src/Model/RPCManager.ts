...
export class RPCNotificationEvent extends MessageEvent<RPCNotification> {
    constructor(
        ...
        eventInit?: MessageEventInit<RPCNotification>,
    ) {
...
type RPCMessageMessagerEventListener = (
    this: IRPCMessageManager,
...
export interface IRPCMessageManager extends EventTarget {
    ...
    addEventListener(
        name: RPCMessageManagerEventType,
        listener: RPCMessageMessagerEventListener,
    ): void;
    addEventListener(
        name: string,
    ...
    implements IRPCMessageManager
{
        ...
        return new Promise<void>((resolve, reject) => {
            ...
            this.ws.onmessage = (e) => {
                ...
                if ("id" in data) {
                    ...
                    this.dispatchEvent(
                        new RPCNotificationEvent(data as RPCNotification),
                    );
                }
            };
            this.ws.onopen = () => {
    ...
    addEventListener(
        ...
        callback:
            | RPCMessageMessagerEventListener
