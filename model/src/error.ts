...
export class InvalidRequestError extends RPCErrorBy(RPCErrorCode.InvalidRequest) {
    constructor(message: string) {
        super(message);
    }
}

export class MethodNotFoundError extends RPCErrorBy(RPCErrorCode.MethodNotFound) {
...
export class UnknownChunkContentError extends RPCErrorBy(RPCErrorCode.UnknownChunkContent) {
...
export class PermissionDeniedError extends RPCErrorBy(RPCErrorCode.PermissionDenied) {
}
